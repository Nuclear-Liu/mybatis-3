 ...
 * manage transactions. MyBatis 数据库会话接口： 1. 执行命令 2. 获取映射器 3. 管理事务
 *
...
public interface SqlSession extends Closeable {
  ...
  /**
   * Retrieve a list of mapped objects from the statement key. 根据 statement(namespace.id) 检索映射对象 list 集合.
   *
   * @param <E>
